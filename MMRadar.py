...
weather = int(input("Any weather? (1 for custom, anything for none)"))
if weather == 1:
    rainny = int(input("Rain? (1 for rain, anything for no rain)"))
    foggy = int(input("Fog? (1 for fog, anything for no fog)"))
else:
    rainny = 0
    foggy = 0
